 ...
 *   - memory_relocation.h (fix-up table management).
...
boolean instruction_encoder(const opcode *opcode, const operand *src_operand, const operand *dest_operand,
                                assembler_context *asmContext, unsigned short **encoded_buff_out, unsigned short *words_amount_out) {
