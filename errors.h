 ...
 */
typedef enum error_position {
    FIRST_PASS,     /**< Error occurred during the first pass */
    SECOND_PASS,    /**< Error occurred during the second pass */
    PRE_PROCESSOR  /**< Error occurred during preprocessing */
...
typedef struct error {
    error_position position;  /**< Stage where the error occurred */
 ...
 * @param asmContext Pointer to the current assembler context (used to
 *                   retrieve file name, line numbers, and error position).
 */
